...
contextBridge.exposeInMainWorld('aether', {
  ...
  repairRuntime: () => ipcRenderer.invoke('aether:repair-runtime'),
  debugLog: (message, meta) => ipcRenderer.invoke('aether:debug-log', { message, meta }),
  ...
  generateLockRecoveryOtp: () => ipcRenderer.invoke('aether:lock-generate-otp'),
  setAppLock: (password, useTouchId, recoveryKey, recoveryOtpSecret) => ipcRenderer.invoke('aether:lock-set-password', { password, useTouchId, recoveryKey, recoveryOtpSecret }),
  ...
  disableAppLockRecovery: (recoveryKey) => ipcRenderer.invoke('aether:lock-disable-recovery', { recoveryKey }),
  disableAppLockRecoveryOtp: (code) => ipcRenderer.invoke('aether:lock-disable-otp', { code }),
  ...
  setWindowsTitleBarCompact: (compact) => ipcRenderer.invoke('aether:window-set-titlebar-compact', { compact }),
